...
use App\Policies\BankTransferBatchPolicy;
...
use App\Policies\MemberStoreAccountPolicy;
use App\Policies\MemberStoreDelegatePolicy;
use App\Policies\MemberStoreFundingRequestPolicy;
use App\Policies\OrganizationPolicy;
use App\Policies\OvertimeRequestPolicy;
use App\Policies\PayrollApprovalPolicy;
use App\Policies\PayrollPolicy;
use App\Policies\PointTransactionPolicy;
use App\Policies\PosMemberPointPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    protected function configureDefaults(): void
    {
        ...
        DB::prohibitDestructiveCommands(
            ! app()->environment('local', 'testing', 'playwright'),
        );
    ...
    protected function registerPolicies(): void
    {
        ...
        Gate::policy(BankTransferBatch::class, BankTransferBatchPolicy::class);
        ...
        Gate::policy(MemberStoreAccount::class, MemberStoreAccountPolicy::class);
        Gate::policy(MemberStoreDelegate::class, MemberStoreDelegatePolicy::class);
        Gate::policy(MemberStoreFundingRequest::class, MemberStoreFundingRequestPolicy::class);
        Gate::policy(OvertimeRequest::class, OvertimeRequestPolicy::class);
        Gate::policy(Organization::class, OrganizationPolicy::class);
        Gate::policy(Payroll::class, PayrollPolicy::class);
        Gate::policy(PayrollApproval::class, PayrollApprovalPolicy::class);
        ...
        Gate::policy(PosMemberPoint::class, PosMemberPointPolicy::class);
