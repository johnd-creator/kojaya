        ...
        return [
            ...
            'MemberStoreAccountResource' => [
                ...
                'properties' => [
                    ...
                    'available_credit' => ['type' => 'integer'],
                    'available_spending' => ['type' => 'integer'],
                    'balance_label' => ['type' => 'string', 'enum' => ['Saldo tersimpan', 'Pemakaian/utang toko']],
            ...
            'MemberStoreLedgerEntryResource' => [
                'type' => 'object',
                'required' => [
                    'id',
                    'entry_type',
                ...
                'properties' => [
                    ...
                    'entry_type_label' => ['type' => 'string'],
                    'amount' => ['type' => 'integer'],
                    'effect' => ['type' => 'string', 'enum' => ['credit', 'debit']],
                    'balance_before' => ['type' => 'integer'],
                    'balance_after' => ['type' => 'integer'],
                    'reference_type' => ['type' => 'string', 'enum' => ['pos_transaction', 'pos_return', 'funding_request', 'store_account', 'ledger_entry'], 'nullable' => true],
                    ...
                    'purchase_note' => ['type' => 'string', 'nullable' => true, 'maxLength' => 500],
                    'reason' => ['type' => 'string', 'nullable' => true],
                    'status' => ['type' => 'string', 'enum' => ['purchase', 'refund', 'void'], 'nullable' => true],
            ...
            'MemberStoreAccountSummaryResponse' => [
                'type' => 'object',
                'required' => ['data'],
                'properties' => [
                    'data' => ['$ref' => '#/components/schemas/MemberStoreAccountResource'],
                ],
            ],
            'PaginatedMemberStoreLedgerResponse' => [
                'type' => 'object',
                'required' => ['data', 'links', 'meta'],
                'properties' => [
                    'data' => ['type' => 'array', 'items' => ['$ref' => '#/components/schemas/MemberStoreLedgerEntryResource']],
                    'links' => ['$ref' => '#/components/schemas/ApiPaginationLinks'],
                    'meta' => ['$ref' => '#/components/schemas/ApiPaginationMeta'],
                ],
            ],
