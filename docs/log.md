...
## 🎯 2026-09-03 - Canonical Organization Isolation Foundation (SEC-P1-01 & R1)
...
- Maintained centralized, explicit global permission registry in `OrganizationScopeService::GLOBAL_PERMISSIONS` and added read-only accessor `registeredGlobalPermissions()`.
