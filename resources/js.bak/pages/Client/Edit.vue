    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex flex-1 flex-col gap-6 p-6 max-w-2xl mx-auto w-full">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold tracking-tight text-zinc-900 dark:text-white">Edit Client</h1>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <Input
                                ...
                                required
                            />
                            <span v-if="form.errors.code" class="text-xs text-red-500 mt-1">{{ form.errors.code }}</span>
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <Textarea
                            ...
                            class="min-h-[80px]"
                        />
                        <span v-if="form.errors.address" class="text-xs text-red-500 mt-1">{{ form.errors.address }}</span>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            />
                            <span v-if="form.errors.tax_id" class="text-xs text-red-500 mt-1">{{ form.errors.tax_id }}</span>
                        </div>
                        <div>
                            ...
                            <span v-if="form.errors.client_type" class="text-xs text-red-500 mt-1">{{ form.errors.client_type }}</span>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <span v-if="form.errors.contact_person" class="text-xs text-red-500 mt-1">{{ form.errors.contact_person }}</span>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <Input
                                ...
                                required
                            />
                            <span v-if="form.errors.phone" class="text-xs text-red-500 mt-1">{{ form.errors.phone }}</span>
                        </div>
                        <div>
                            ...
                            <Input
                                ...
                                required
                            />
                            <span v-if="form.errors.email" class="text-xs text-red-500 mt-1">{{ form.errors.email }}</span>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-zinc-500 mt-1">Assign client to specific organization if needed</p>
                        <span v-if="form.errors.organization_id" class="text-xs text-red-500 mt-1">{{ form.errors.organization_id }}</span>
                    </div>
