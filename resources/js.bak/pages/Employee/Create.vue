...
import { index as employeesIndex, store as employeeStore } from '@/actions/App/Http/Controllers/EmployeeController';
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-6 max-w-4xl mx-auto w-full">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold tracking-tight text-zinc-900 dark:text-white">New Employee</h1>
                    <p class="text-sm text-zinc-500">Add a new employee and assign them to a unit.</p>
                </div>
            </div>
