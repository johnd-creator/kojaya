...
import { store, update } from '@/actions/App/Http/Controllers/OrganizationController';
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        >
                            ...
                            <option 
                                v-for="org in allOrganizations.filter(o => !organization || o.id !== organization.id)" 
                                :key="org.id" 
                                :value="org.id"
                            >
                                {{ org.code }} - {{ org.name }}
                        ...
                        <p v-if="form.errors.parent_id" class="mt-2 text-sm text-red-600">{{ form.errors.parent_id }}</p>
                    </div>
                </div>

                <DialogFooter class="mt-6">
                    <Button variant="secondary" @click="emit('close')" type="button">Cancel</Button>
