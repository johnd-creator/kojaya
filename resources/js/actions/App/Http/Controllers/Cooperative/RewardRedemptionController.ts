...
* @see app/Http/Controllers/Cooperative/RewardRedemptionController.php:16
...
const RewardRedemptionController = { index, show, updateStatus }

export default RewardRedemptionController