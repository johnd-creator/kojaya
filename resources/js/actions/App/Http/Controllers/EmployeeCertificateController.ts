...
* @see app/Http/Controllers/EmployeeCertificateController.php:16
...
* @see app/Http/Controllers/EmployeeCertificateController.php:26
* @route '/api/employees/{employeeId}/certificates'
*/
...
* @see app/Http/Controllers/EmployeeCertificateController.php:35
...
* @see app/Http/Controllers/EmployeeCertificateController.php:43
* @route '/api/employees/{employeeId}/certificates/{id}'
*/
...
* @see app/Http/Controllers/EmployeeCertificateController.php:53
* @route '/api/employees/{employeeId}/certificates/{id}'
*/
...
* @see app/Http/Controllers/EmployeeCertificateController.php:71
