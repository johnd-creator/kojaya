...
* @see app/Http/Controllers/MemberPortalController.php:102
* @route '/member/onboarding'
*/
...
* @see app/Http/Controllers/MemberPortalController.php:113
...
* @see app/Http/Controllers/MemberPortalController.php:251
* @route '/member/profile'
*/
...
* @see app/Http/Controllers/MemberPortalController.php:157
* @route '/member/loans'
*/
...
const MemberPortalController = { dashboard, onboarding, submitOnboarding, markOnboardingStep, profile, updateProfile, notifications, savings, loans, applyLoan, points, rewards, redeemReward, transactions }
