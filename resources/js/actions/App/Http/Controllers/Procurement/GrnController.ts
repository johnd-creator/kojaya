...
* @route '/procurement/grns/from-po/{purchaseOrder}'
*/
const createFromPoForm = (args: { purchaseOrder: string | number | { id: string | number } } | [purchaseOrder: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/procurement/grns/from-po/{purchaseOrder}'
*/
createFromPoForm.post = (args: { purchaseOrder: string | number | { id: string | number } } | [purchaseOrder: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: createFromPo.url(args, options),
    method: 'post',
})
