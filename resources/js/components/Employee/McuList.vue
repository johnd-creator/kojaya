...
import { Activity, Heart, AlertCircle, Calendar, Plus, Upload, Trash2, Pencil, File as FileIcon } from 'lucide-vue-next';
...
const groupedRecords = computed(() => {
    return {
        ...
        fitWithRestriction: mcuRecords.value.filter((m) => m.result === 'FIT_WITH_RESTRICTION'),
...
<template>
    <div class="space-y-4">
        ...
        <div v-else-if="!hasRecords" class="py-12 text-center">
            <Activity class="mx-auto mb-4 h-16 w-16 text-neutral-300 dark:text-neutral-700" />
            <h3 class="text-lg font-semibold text-neutral-900 dark:text-neutral-100">
                No MCU records yet
            </h3>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div class="mt-1 text-xs">
                            ...
                            <span
                                :class="[
                                    isOverdue(mcu) ? 'text-red-600 font-medium' : 'text-neutral-700',
                                ]"
                            >
                                {{ mcu.next_checkup_date ? formatDate(mcu.next_checkup_date) : 'Not set' }}
                    ...
                    <DropdownMenu v-if="!readonly">
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem
                                ...
                                @click="window.open(getDocumentUrl(mcu.document_path), '_blank')"
                            >
                            ...
                            <AlertDialog>
                                ...
                                <AlertDialogContent>
                                    <AlertDialogHeader>
                                        ...
                                        <AlertDialogDescription>
                                            Are you sure you want to delete this MCU record? This action cannot be undone.
                                        </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
