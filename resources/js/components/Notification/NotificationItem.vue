...
const iconData = computed(() => {
    return iconMap[props.notification.type as keyof typeof iconMap] || {
        icon: Bell,
...
<template>
    ...
    >
        ...
        <div v-if="loading" class="absolute inset-0 flex items-center justify-center bg-white/50 dark:bg-neutral-900/50">
            <div class="h-4 w-4 animate-spin rounded-full border-2 border-neutral-300 border-t-neutral-900 dark:border-neutral-700 dark:border-t-neutral-100" />
        </div>
    </div>
</template>
