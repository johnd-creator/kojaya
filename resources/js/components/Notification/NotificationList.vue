...
const hasMorePages = computed(
  () => meta.value && currentPage.value < meta.value.last_page,
);
...
<template>
  <div class="space-y-4">
    <div class="flex items-center justify-between">
      <div
        class="flex gap-1 rounded-lg border border-neutral-200 p-1 dark:border-neutral-800"
      >
        <button
          :class="[
    ...
    <div v-if="hasMorePages && !loading" class="flex justify-center pt-4">
