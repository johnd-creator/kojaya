...
import { Loader2, Save, Mail, Database, Bell as BellIcon } from 'lucide-vue-next';
...
<template>
    <div class="space-y-6">
        ...
        <div v-else class="space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    >
                        <div class="flex items-center gap-3">
                            ...
                            />
                            <div>
                                <Label :for="`channel-${channel.value}`" class="cursor-pointer font-medium">
                                    {{ channel.label }}
                                </Label>
                                <p class="text-xs text-neutral-500 dark:text-neutral-500">
                                    {{ channel.value === 'mail' ? 'Receive notifications via email' : channel.value === 'database' ? 'Receive in-app notifications' : 'Receive push notifications' }}
                                </p>
                            </div>
                        </div>
                        <Switch
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between rounded-lg border border-neutral-200 p-4 dark:border-neutral-800">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <Label for="database-enabled" class="cursor-pointer font-medium">
                    ...
                    <div class="flex items-center justify-between rounded-lg border border-neutral-200 p-4 dark:border-neutral-800">
                        <div class="flex items-center gap-3">
                            <BellIcon class="h-5 w-5 text-neutral-600 dark:text-neutral-400" />
                            <div>
            ...
            <div class="flex items-center justify-between rounded-lg border border-neutral-200 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-900">
                <div>
                    <p
                        v-if="saveSuccess"
