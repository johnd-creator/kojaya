...
<template>
  <div
    class="team-calendar bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6"
  >
    <div class="space-y-6">
      <!-- Calendar Header -->
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
          ...
          <span
            class="font-bold text-zinc-900 dark:text-white min-w-[140px] text-center"
          >
      ...
      <div class="grid grid-cols-7 gap-1">
        ...
        <div
          ...
          :key="day"
          class="text-center text-xs font-medium text-zinc-500 dark:text-zinc-400 py-2"
        >
          {{ day }}
        </div>
