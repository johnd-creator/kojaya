    ...
    <div class="flex flex-1 flex-col gap-6 p-6 w-full">
      ...
      >
        <div>
          ...
          <p class="text-zinc-500 mt-1">
            Daily attendance records per employee and unit.
          </p>
        </div>
        ...
        >
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4 items-end">
            ...
            <div>
              ...
              <select
                v-model="selectedOrg"
                class="w-full flex h-10 rounded-md border border-zinc-200 bg-zinc-50 px-3 py-2 text-sm dark:border-zinc-800 dark:bg-zinc-800/50"
              >
      ...
      >
              ...
              <tr v-if="!attendances.data.length">
                <td colspan="6" class="py-12 text-center text-zinc-500">
                  ...
                  <p class="text-sm mt-1">
                    Adjust filters or record a new attendance.
                  </p>
                </td>
              </tr>
            </tbody>
        ...
        <div
          ...
          class="px-5 py-4 border-t border-zinc-200 dark:border-zinc-800 flex items-center justify-between"
        >
          <p class="text-sm text-zinc-500">
            Showing {{ attendances.from }}–{{ attendances.to }} of
            {{ attendances.total }}
          </p>
