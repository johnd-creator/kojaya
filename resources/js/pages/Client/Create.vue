    ...
    <div class="flex flex-1 flex-col gap-6 p-6 max-w-3xl mx-auto w-full">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription
            >Enter the official details of the client
        ...
        <CardContent>
          <form @submit.prevent="submit" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="space-y-2">
                <Label for="code" class="flex items-center gap-2">
                  <FileText class="h-3 w-3 text-zinc-500" /> Client Code
              ...
              <div class="space-y-2">
                <Label for="name" class="flex items-center gap-2">
                  <Building2 class="h-3 w-3 text-zinc-500" /> Client Name
                  <span class="text-red-500">*</span>
                </Label>
                <Input
                  id="name"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="space-y-2">
                ...
                <Select v-model="form.client_type">
                  <SelectTrigger
                    :class="{
                      'border-red-500 ring-red-500': form.errors.client_type,
                    }"
                  >
                  ...
                  <SelectContent>
                    <SelectItem value="PLN"
                      >PLN (State Electricity Company)</SelectItem
                    >
            ...
            <div
              class="border-t border-zinc-100 dark:border-zinc-800 my-4"
            ></div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div class="space-y-2">
                <Label for="contact_person" class="flex items-center gap-2">
                  <User class="h-3 w-3 text-zinc-500" /> PIC Name
                  <span class="text-red-500">*</span>
                </Label>
                <Input
                  id="contact_person"
              ...
              <div class="space-y-2">
                <Label for="phone" class="flex items-center gap-2">
                  <Phone class="h-3 w-3 text-zinc-500" /> Phone
                  <span class="text-red-500">*</span>
                </Label>
                <Input
                  id="phone"
              ...
              <div class="space-y-2">
                <Label for="email" class="flex items-center gap-2">
                  <Mail class="h-3 w-3 text-zinc-500" /> Email
                  <span class="text-red-500">*</span>
                </Label>
                <Input
                  id="email"
            ...
            <div class="space-y-2 pt-4">
              <Label for="organization_id"
                >Assign to Organization (Internal)</Label
              >
              <Select v-model="form.organization_id">
                <SelectTrigger>
                  <SelectValue
                    placeholder="Select internal organization unit"
                  />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem
              ...
              <p class="text-xs text-zinc-500">
                Optionally link this client to a specific internal business
                unit.
              </p>
            </div>
            ...
            <!-- Actions -->
            <div
              class="flex justify-end gap-3 pt-6 border-t border-zinc-100 dark:border-zinc-800"
            >
