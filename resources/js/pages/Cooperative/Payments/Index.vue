      ...
      >
        ...
        <div class="mt-5 space-y-5">
          <div class="space-y-2">
            ...
            <div
              class="rounded-xl border border-zinc-200/70 bg-zinc-50/90 p-2 dark:border-zinc-800/70 dark:bg-zinc-950/70"
            >
              <div
                v-if="selectedMember"
                class="flex items-center justify-between gap-3 rounded-lg bg-white px-3 py-2 text-sm shadow-sm dark:bg-zinc-900"
              >
                <div>
              ...
              <div v-else class="space-y-2">
                <button
                  ...
                  :key="member.id"
                  type="button"
                  class="flex w-full items-center justify-between rounded-lg px-3 py-2 text-left text-sm transition hover:bg-white dark:hover:bg-zinc-900"
            ...
            <tbody class="divide-y">
              <tr v-for="payment in payments.data" :key="payment.id">
                <td class="px-4 py-3">
                  ...
                  <div class="text-xs text-zinc-500">
                    No. Anggota {{ payment.member?.member_no || "-" }}
                  </div>
                </td>
                <td>
                  {{
