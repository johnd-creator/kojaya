...
const form = useForm({
  ...
  birth_date: props.employee.birth_date
    ? props.employee.birth_date.split("T")[0]
    : "",
...
const confirmTerminateEmployee = (): void => {
...
<template>
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="flex h-full flex-1 flex-col gap-6 p-6 max-w-4xl mx-auto w-full">
        ...
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <p class="text-sm text-zinc-500">
              {{ form.employee_code }} - {{ form.first_name }}
              {{ form.last_name }}
            </p>
          </div>
        </div>
          ...
          <Dialog v-model:open="showTransferModal">
            ...
            <DialogContent class="sm:max-w-md">
              ...
              <form @submit.prevent="submitTransfer" class="space-y-4 mt-2">
                <p class="text-sm text-zinc-500">
                  Selecting a new unit will update the employee's organization
                  and save their profile profile.
                </p>
                <div class="grid gap-2">
                  <Label>New Unit / Organization</Label>
                  <select
                    v-model="transferForm.organization_id"
                    required
                    class="flex h-10 w-full rounded-md border border-zinc-200 bg-white px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-950 dark:border-zinc-800 dark:bg-zinc-950"
                  >
                    <option
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="space-y-4">
              ...
              <div class="grid gap-2">
                ...
                />
                <span
                  v-if="form.errors.bank_account_holder"
                  class="text-xs text-red-500"
                  >{{ form.errors.bank_account_holder }}</span
                >
              </div>
              ...
              >
                <div class="flex items-center gap-2">
                  <component
                    :is="
                      bankValidationStatus.valid ? CheckCircle : AlertTriangle
                    "
                    class="h-4 w-4"
                    :class="
                      bankValidationStatus.valid
      ...
      <FamilyMembers :employee="employee" :all-employees="allEmployees" />
      ...
      >
        <div class="flex items-start justify-between gap-4">
          <div>
            ...
            <p class="text-sm text-zinc-500 mt-1">
              Enable Employee Self-Service login for this employee. Requires an
            ...
            >
              <span
                class="inline-block w-2 h-2 rounded-full bg-zinc-300 dark:bg-zinc-700"
              ></span>
        ...
        >
          ⚠ Please save an email address on this employee profile first to
          enable ESS access.
        </p>
        <p v-if="employee.user_id" class="mt-3 text-xs text-zinc-400">
          Default password is the Employee Code. Advise the employee to change
    ...
    <ConfirmDialog
      ...
      message="Are you sure you want to terminate this employee? Data will be archived."
      confirm-label="Terminate"
      @confirm="confirmTerminateEmployee"
    />
  </AppLayout>
</template>
