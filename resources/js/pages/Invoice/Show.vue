...
import { ArrowLeft, FileText, Calendar, DollarSign, User } from 'lucide-vue-next';
import { index as invoicesIndex, update as invoicesUpdate, exportEfakturCsv } from '@/actions/App/Http/Controllers/InvoiceController';
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="flex items-center gap-3">
                            <h1 class="text-2xl font-bold tracking-tight text-zinc-900 dark:text-white">{{ invoice.invoice_no }}</h1>
                    ...
                    <div class="flex items-center gap-2">
                        <Button variant="outline" as-child>
                            <a :href="exportEfakturCsv({ invoice: invoice.id }).url" target="_blank">
                                Export e‑Faktur CSV
                            </a>
                        </Button>
                    </div>
                    ...
                    <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm p-6">
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <div class="font-medium">{{ invoice.unit?.name || invoice.organization?.name || '-' }}</div>
                            </div>
                        </div>
                    </div>
                </div>
