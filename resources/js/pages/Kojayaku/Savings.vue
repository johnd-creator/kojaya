      ...
      <div class="flex flex-col gap-6">
        <header class="flex items-center gap-5">
          ...
          <div>
            ...
            <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
              Lacak saldo simpanan dan status pembayaran iuran wajib Anda dengan
              mudah.
            </p>
          </div>
        </header>
        ...
        >
          ...
          >
            ...
            <div class="min-w-0">
              ...
              <p
                class="mt-1.5 text-xl font-extrabold text-zinc-900 dark:text-white tracking-tight sm:text-2xl"
              >
                {{ card.value }}
              </p>
              <p
                class="mt-1 text-xs text-zinc-500 dark:text-zinc-400 leading-normal"
              >
                {{ card.caption }}
              </p>
            </div>
        ...
        <section class="grid grid-cols-2 gap-3 sm:gap-4 xl:grid-cols-4">
          ...
          >
            ...
            <div class="min-w-0">
              ...
              <p
                class="mt-1 text-base font-extrabold text-zinc-900 dark:text-white tracking-tight sm:text-lg"
              >
                {{ card.value }}
              </p>
              <p
                class="mt-0.5 text-[10px] text-zinc-500 dark:text-zinc-400 leading-normal"
              >
                {{ card.caption }}
              </p>
            </div>
        ...
        >
          ...
          >
            <div class="flex items-start gap-4">
              ...
              <div>
                ...
                <p class="mt-0.5 text-sm text-zinc-500 dark:text-zinc-400">
                  Pantau bulan apa saja yang sudah dibayar, belum dibayar, atau
                  masih sebagian.
                </p>
              </div>
            </div>
            <div class="grid grid-cols-3 gap-2 text-center sm:min-w-[360px]">
              <div class="rounded-2xl bg-zinc-50 dark:bg-zinc-800/50 px-3 py-2">
                ...
                <p
                  class="mt-1 text-sm font-extrabold text-zinc-900 dark:text-white"
                >
              ...
              >
                ...
                <p
                  class="mt-1 text-sm font-extrabold text-emerald-800 dark:text-emerald-400"
                >
                  {{ wajibSummary.paid_invoices }}
                </p>
              </div>
              <div
                class="rounded-2xl bg-amber-50 dark:bg-amber-950/20 px-3 py-2"
              >
                <p
                ...
                <p
                  class="mt-1 text-sm font-extrabold text-amber-800 dark:text-amber-400"
                >
          ...
          <div class="grid gap-4 p-4 sm:p-6 lg:grid-cols-[0.85fr_1.15fr]">
            <div
              class="rounded-2xl border border-emerald-100 bg-emerald-50/60 dark:border-emerald-900/20 dark:bg-emerald-950/10 p-4 sm:p-5"
            >
              <p
              ...
              <div class="mt-4 space-y-3">
                <div class="flex items-center justify-between gap-4">
                  <span
                    class="text-sm text-emerald-800 dark:text-emerald-300/70"
                    >Total tertagih</span
                  >
                  <span
                    class="font-extrabold text-emerald-950 dark:text-emerald-100"
                  >
                ...
                <div class="flex items-center justify-between gap-4">
                  ...
                  >
                  <span
                    class="font-extrabold text-amber-700 dark:text-amber-400"
                  >
            ...
            <div
              class="overflow-x-auto rounded-2xl border border-zinc-100 dark:border-zinc-800"
            >
              <table class="w-full text-left text-sm">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td
                      class="px-4 py-3 text-right font-semibold text-zinc-800 dark:text-zinc-200"
                    >
        ...
        >
          ...
          >
            <div>
              <h2
                class="text-lg font-bold text-zinc-900 dark:text-white tracking-tight"
              >
                Status Pembayaran Iuran
              </h2>
              <p
                class="mt-1 text-sm text-zinc-500 dark:text-zinc-400 font-medium"
              >
            ...
            <div class="flex items-center gap-5">
              ...
              <div class="text-right">
                <p
                  class="text-2xl font-extrabold text-zinc-900 dark:text-white tracking-tight"
                >
                  {{ formatCurrency(journey.amount) }}
                </p>
                <p
                  class="text-[10px] font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider mt-0.5"
                >
              ...
              <div
                ...
                :class="
                  step.completed
                    ...
                    : 'bg-zinc-300 dark:bg-zinc-700 dark:text-zinc-500'
                "
              >
                <Check v-if="step.completed" class="h-5 w-5" />
                <span
                  v-else
                  class="h-2 w-2 rounded-full bg-white dark:bg-zinc-700"
                />
              </div>
              <p
                class="mt-3 text-sm font-bold text-zinc-800 dark:text-zinc-200 leading-tight"
              >
                {{ step.label }}
              </p>
        ...
        <section class="grid gap-6 xl:grid-cols-[1fr_1.05fr]">
          ...
          >
            <div>
              <div
                class="flex items-center gap-4 border-b border-zinc-50 dark:border-zinc-800 p-4 sm:p-6"
              >
                <div
              ...
              <div class="overflow-x-auto">
                <table class="w-full text-left text-sm">
                  ...
                  >
                    ...
                    >
                      <td
                        class="px-4 py-3 sm:px-6 sm:py-4 font-medium text-zinc-500 dark:text-zinc-400"
                      >
                        {{ formatDate(entry.posted_at) }}
                      </td>
                      <td
                        class="px-4 py-3 sm:px-6 sm:py-4 font-semibold text-zinc-800 dark:text-zinc-200"
                      >
                        {{ entry.entry_type }}
                      </td>
                      <td
                        class="px-4 py-3 sm:px-6 sm:py-4 text-zinc-600 dark:text-zinc-300"
                      >
                        {{
                      ...
                      <td
                        class="px-4 py-3 sm:px-6 sm:py-4 text-right text-zinc-500 dark:text-zinc-400"
                      >
                        {{
                      ...
                      <td
                        class="px-4 py-3 sm:px-6 sm:py-4 text-right font-extrabold text-emerald-800 dark:text-emerald-400"
                      >
                        {{
                ...
                <table class="w-full text-left text-sm">
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td
                        class="px-4 py-3 sm:px-6 sm:py-4 text-right font-extrabold text-zinc-800 dark:text-zinc-300"
                      >
                        {{ formatCurrency(invoice.amount) }}
                      </td>
                    </tr>
        ...
        >
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              >
                Seluruh data simpanan dan pembayaran iuran Anda dilindungi
                dengan sistem keamanan berlapis demi kenyamanan bertransaksi.
              </p>
            </div>
          </div>
          <div
            class="flex items-center gap-2 text-sm font-semibold text-emerald-800 dark:text-emerald-400"
          >
            <ShieldCheck
              class="h-5 w-5 text-emerald-700 dark:text-emerald-400 animate-pulse"
            />
