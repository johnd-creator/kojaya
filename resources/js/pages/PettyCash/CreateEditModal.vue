    ...
    <DialogContent class="sm:max-w-[425px]">
      <DialogHeader>
        ...
        <DialogDescription>
          {{
            isEditing
              ? "Update petty cash account details."
              : "Add a new petty cash account."
          }}
        </DialogDescription>
      </DialogHeader>
      ...
      <form @submit.prevent="submit" class="grid gap-4 py-4">
        ...
        <div class="grid gap-2">
          ...
          <Input
            id="name"
            v-model="form.name"
            placeholder="e.g. Petty Cash Finance Dept"
          />
        ...
        <div class="grid gap-2">
          ...
          <Input
            ...
            placeholder="0.00"
          />
          <span v-if="form.errors.limit" class="text-sm text-red-500">{{
            form.errors.limit
          }}</span>
        </div>
