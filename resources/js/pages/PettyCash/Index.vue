                            ...
                            >
                                <td class="py-4 px-6">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <Link :href="show({ petty_cash: account.id }).url()" class="font-medium text-zinc-900 dark:text-zinc-100 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                                                {{ account.name }}
                                            </Link>
