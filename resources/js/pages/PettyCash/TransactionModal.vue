    ...
    <DialogContent class="sm:max-w-[500px]">
      ...
      <form @submit.prevent="submit" class="grid gap-4 py-4">
        <div class="grid grid-cols-2 gap-4">
          <div class="grid gap-2">
            ...
            <span
              ...
              >{{ form.errors.transaction_date }}</span
            >
          </div>
          <div class="grid gap-2">
        ...
        <div class="grid gap-2">
          ...
          />
          <span v-if="form.errors.reference_no" class="text-sm text-red-500">{{
        ...
        <div class="grid gap-2">
          ...
          />
          <span v-if="form.errors.proof_file" class="text-sm text-red-500">{{
