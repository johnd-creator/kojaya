...
import { index as projectsIndex, edit as projectEdit } from '@/actions/App/Http/Controllers/ProjectController';
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex flex-1 flex-col gap-6 p-6 max-w-4xl mx-auto w-full">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold tracking-tight text-zinc-900 dark:text-white">Edit Project</h1>
                    <p class="text-sm text-zinc-500">{{ form.project_code }} - {{ form.name }}</p>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm p-6">
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="grid gap-2">
                        ...
                        <Textarea id="description" v-model="form.description" :rows="3" placeholder="Project description..."></Textarea>
                        <span v-if="form.errors.description" class="text-xs text-red-500">{{ form.errors.description }}</span>
                    </div>

                    <div class="grid gap-2">
                        <Label for="notes">Notes</Label>
                        <Textarea id="notes" v-model="form.notes" :rows="2" placeholder="Additional notes..."></Textarea>
