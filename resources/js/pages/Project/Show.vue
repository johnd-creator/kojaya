...
import { ArrowLeft, Users, Calendar, DollarSign, Plus, Upload, FileText, Trash2, Wallet } from 'lucide-vue-next';
...
const GanttChart = defineAsyncComponent(() => import('@/components/project/GanttChart.vue'));
                            ...
                            <div class="space-y-4">
                                ...
                                <div v-else-if="viewMode === 'gantt'">
                                    <Suspense>
                                        ...
                                        <template #fallback>
                                            <div class="flex h-[600px] items-center justify-center rounded-lg border bg-white text-sm text-zinc-500 dark:bg-zinc-900 dark:text-zinc-400">
                                                Loading Gantt chart...
                                            </div>
                                        </template>
                                    </Suspense>
