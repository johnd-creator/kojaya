...
const profitBg = computed(() => {
  return props.financialSummary.profit >= 0
      ...
      <div class="flex items-center gap-4">
        ...
        <div>
          ...
          <p class="text-sm text-zinc-500 mt-1">
            Real-time budget control, profitability analysis, and S-Curve
          </p>
        </div>
      </div>
          ...
          <div class="space-y-4">
            ...
            <div class="w-full bg-zinc-100 dark:bg-zinc-800 rounded-full h-2">
              <div
                ...
                :style="{
                  width:
                    financialSummary.cost > 0
                      ? `${(costBreakdown.labor / financialSummary.cost) * 100}%`
                      : '0%',
                }"
              ></div>
            </div>
            ...
            <div class="flex items-center justify-between">
              ...
              <span class="text-sm font-bold">{{
                formatCurrency(costBreakdown.reimbursements)
              }}</span>
            </div>
            <div class="w-full bg-zinc-100 dark:bg-zinc-800 rounded-full h-2">
              <div
                ...
                :style="{
                  width:
                    financialSummary.cost > 0
                      ? `${(costBreakdown.reimbursements / financialSummary.cost) * 100}%`
                      : '0%',
                }"
              ></div>
            </div>
            ...
            <div class="flex items-center justify-between">
              ...
              <span class="text-sm font-bold">{{
                formatCurrency(costBreakdown.petty_cash)
              }}</span>
            </div>
            <div class="w-full bg-zinc-100 dark:bg-zinc-800 rounded-full h-2">
              <div
                ...
                :style="{
                  width:
                    financialSummary.cost > 0
                      ? `${(costBreakdown.petty_cash / financialSummary.cost) * 100}%`
                      : '0%',
                }"
              ></div>
            </div>
