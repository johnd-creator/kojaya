...
<template>
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div
      class="flex h-full flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6 max-w-5xl mx-auto w-full"
    >
      ...
      <form @submit.prevent="submit" class="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription
              >Basic details about your reimbursement request.</CardDescription
            >
          </CardHeader>
          <CardContent class="grid gap-4 md:grid-cols-2">
            <div class="space-y-2">
              ...
              />
              <p
                v-if="form.errors.submission_date"
                class="text-sm text-destructive"
              >
                {{ form.errors.submission_date }}
              </p>
            </div>
            ...
            <CardContent class="pt-6 relative">
              ...
              <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                <div class="space-y-2">
                  ...
                  <p
                    v-if="form.errors[`items.${idx}.category`]"
                    class="text-sm text-destructive"
                  >
                    {{ form.errors[`items.${idx}.category`] }}
                  </p>
                </div>
                ...
                <div class="space-y-2">
                  ...
                  />
                  <p
                    v-if="form.errors[`items.${idx}.amount`]"
                    class="text-sm text-destructive"
                  >
                ...
                <div class="space-y-2">
                  ...
                  />
                  <p
                    v-if="form.errors[`items.${idx}.receipt_date`]"
                    class="text-sm text-destructive"
                  >
                    {{ form.errors[`items.${idx}.receipt_date`] }}
                  </p>
                </div>
                ...
                <div class="space-y-2 md:col-span-2 lg:col-span-3">
                  ...
                  />
                  <p
                    v-if="form.errors[`items.${idx}.description`]"
                    class="text-sm text-destructive"
                  >
                ...
                <div class="space-y-2 lg:col-span-3">
                  ...
                  />
                  <p
                    v-if="form.errors[`items.${idx}.receipt_file`]"
                    class="text-sm text-destructive"
                  >
                    {{ form.errors[`items.${idx}.receipt_file`] }}
                  </p>
                </div>
              </div>
            </CardContent>
