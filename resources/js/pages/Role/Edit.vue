    ...
    <div class="py-12">
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        >
          <div class="p-6">
            <div
              class="mb-6 border-b border-gray-200 pb-5 dark:border-gray-700"
            >
              <h2
              ...
              <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                Check the boxes to assign data visibility and action
            ...
            <form @submit.prevent="submit">
              <div class="space-y-8">
                <div
                  ...
                  :key="moduleName"
                  class="border rounded-lg p-5 dark:border-gray-700"
                >
                  <h3
                    class="text-lg font-medium text-gray-900 border-b pb-3 mb-4 capitalize dark:text-gray-100 dark:border-gray-700"
                  >
