      ...
      >
        <div>
          ...
          <p class="text-zinc-500 mt-1">
            Manage system access levels and hierarchical privileges across
            organizations.
          </p>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <div class="flex items-start justify-between mb-4">
            <div
              class="h-12 w-12 rounded-xl bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 flex items-center justify-center shrink-0"
            >
              <ShieldCheck class="h-6 w-6" />
            </div>
            <div
              class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 text-xs font-semibold"
            >
          ...
          <p
            class="mt-2 text-sm text-zinc-500 dark:text-zinc-400 flex-1 leading-relaxed"
          >
            {{ getRoleDescription(role.name) }}
          </p>

          <div
            class="mt-6 pt-4 border-t border-zinc-100 dark:border-zinc-800 flex items-center justify-between"
          >
            <Button
              variant="ghost"
              class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 -ml-2"
              as-child
            >
