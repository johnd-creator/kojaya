      ...
      >
        <form @submit.prevent="submit" class="space-y-6">
          ...
          <div class="space-y-2">
            ...
            />
            <p v-if="form.errors.specification" class="text-sm text-red-500">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="space-y-2">
              ...
              />
              <p v-if="form.errors.max_stock" class="text-sm text-red-500">
            ...
            <div class="space-y-2">
              ...
              />
              <p v-if="form.errors.reorder_level" class="text-sm text-red-500">
          ...
          <div class="space-y-2">
            ...
            <p v-if="form.errors.organization_id" class="text-sm text-red-500">
