        ...
        <div class="flex h-full flex-1 flex-col gap-6 overflow-x-auto p-6 max-w-7xl mx-auto w-full">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-zinc-500 mt-1">
                        ...
                        <span v-if="warehouse.location" class="ml-3 flex items-center gap-1">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-sm p-6">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <h3 class="font-semibold text-zinc-900 dark:text-white">Overview</h3>
                    </div>
                    <div class="space-y-4">
                        <div>
                        ...
                        <div v-if="warehouse.organization">
                            ...
                            <p class="text-xs text-zinc-500">{{ warehouse.organization.code }}</p>
                        </div>
                    </div>
                </div>
                ...
                <!-- Warehouse Details -->
                <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-sm p-6">
                    <h3 class="font-semibold text-zinc-900 dark:text-white mb-4">Warehouse Details</h3>
                    <div class="space-y-3">
                        <div>
                            <p class="text-xs text-zinc-500">Warehouse Code</p>
                            <p class="text-sm font-medium text-zinc-900 dark:text-white font-mono">
                                {{ warehouse.code }}
                            </p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-medium border mt-1"
                                 :class="getTypeColor(warehouse.type)">
                                {{ getTypeBadge(warehouse.type) }}
                            </div>
                        </div>
                ...
                <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-sm p-6">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <h3 class="font-semibold text-zinc-900 dark:text-white">Inventory Stats</h3>
                    </div>
                    <div class="space-y-4">
                        <div>
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-bold text-amber-600 dark:text-amber-400">
                                {{ warehouse.stocks.reduce((sum, stock) => sum + stock.reserved_quantity, 0) }}
                            </p>
                        </div>
                        <div>
            ...
            <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-sm p-6">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h3 class="font-semibold text-zinc-900 dark:text-white">Current Inventory</h3>
                </div>
                <div v-if="warehouse.stocks.length === 0" class="text-center py-8 text-zinc-500">
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="border-b border-zinc-200 dark:border-zinc-800">
                                <th class="py-3 px-4 font-medium text-sm text-zinc-500">Part Code</th>
                                <th class="py-3 px-4 font-medium text-sm text-zinc-500">Part Name</th>
                                <th class="py-3 px-4 font-medium text-sm text-zinc-500">Unit</th>
                        ...
                        <tbody class="divide-y divide-zinc-100 dark:divide-zinc-800">
                            <tr v-for="stock in warehouse.stocks" :key="stock.id">
                                <td class="py-3 px-4">
                                    <Link :href="`/spare-parts/${stock.spare_part.id}`" class="font-mono text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:underline">
                                        {{ stock.spare_part.code }}
                                    </Link>
                                </td>
                                <td class="py-3 px-4">
                                    <Link :href="`/spare-parts/${stock.spare_part.id}`" class="text-sm font-medium text-zinc-900 dark:text-white hover:underline">
