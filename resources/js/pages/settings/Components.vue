      ...
      <div class="space-y-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription
              >Button variants, sizes, and states.</CardDescription
            >
          </CardHeader>
          <CardContent class="space-y-6">
            ...
            <div class="space-y-2">
              ...
              >
                ...
                <Button> Next Step <ArrowRight class="ml-2 h-4 w-4" /> </Button>
              </div>
            </div>
            ...
            <div class="space-y-2">
              ...
              >
                ...
                <Button
                  variant="outline"
                  size="icon"
                  class="text-destructive hover:text-destructive border-destructive/50 hover:border-destructive hover:bg-destructive/10"
                  title="Delete"
                >
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription
              >Callout components for user attention.</CardDescription
            >
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription
              >Overlay dialogs for confirming actions or forms.</CardDescription
            >
          </CardHeader>
          <CardContent>
            <Dialog>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription
              >Standardized status indicators for transactions and
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription
              >Standard header with breadcrumbs and actions.</CardDescription
            >
          </CardHeader>
          <CardContent
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription
              >Advanced table with search, pagination, and status
              ...
              <template #actions="{ row }">
                <div class="flex items-center justify-end gap-2">
                  <Button
                    variant="ghost"
                    size="icon"
                    class="h-8 w-8 text-zinc-500 hover:text-indigo-600"
                  >
                    <Eye class="h-4 w-4" />
                  </Button>
                  <Button
