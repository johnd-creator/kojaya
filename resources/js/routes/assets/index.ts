...
* @see app/Http/Controllers/AssetController.php:12
* @route '/assets'
*/
...
* @see app/Http/Controllers/AssetController.php:35
* @route '/assets/create'
*/
...
* @see app/Http/Controllers/AssetController.php:51
* @route '/assets/{asset}'
*/
...
* @see app/Http/Controllers/AssetController.php:65
